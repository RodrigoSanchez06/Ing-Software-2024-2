...
# Clase que representa a una renta
class Renta(db.Model):

    __tablename__ = "rentar"
    idRentar = Column(Integer, primary_key=True)
    idUsuario = Column(
        Integer, ForeignKey("usuarios.idUsuario", ondelete="CASCADE"), nullable=False
    )
    ...
    estatus = Column(Boolean, nullable=True, default=None)
