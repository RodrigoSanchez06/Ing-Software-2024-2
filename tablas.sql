...
DROP TABLE IF EXISTS `rentar`;

-- Crear la nueva tabla con el tipo de dato BOOLEAN
CREATE TABLE `usuarios` (
  ...
  `superUser` BOOLEAN DEFAULT NULL,
...
ALTER TABLE rentar DROP FOREIGN KEY nombre_de_la_restriccion;
